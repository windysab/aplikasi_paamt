                    ...
                    <div class="card-body bg-success">
                        ...
                        <form method="POST" action="{{ route('gugatan_cerai.submit') }}">
                            ...
                            <div class="container">
                                ...
                                <!-- Alasan Cerai -->
                                <div class="form-group">
                                    <textarea name="alasan_cerai" id="alasan_cerai" class="form-control" placeholder="s" required readonly hidden></textarea>
                                </div>
                                <!-- Tombol Pop up -->
                                ...
                                <div class="form-group">
                                    <textarea name="alasan_cerai_2" id="alasan_cerai_2" class="form-control" placeholder="saasd" required readonly></textarea>
                                </div>
                                <!-- Tombol Pop up -->
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal_alasan2">
