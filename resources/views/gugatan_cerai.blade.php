                                            ...
                                            <option value="(e) Sering keluar pada malam hari / pulang pada waktu dini hari / tidak pulang berhari – hari">
                                                ...
                                                <div class="container">
                                                    <div class="row justify-content-center">
                                                        <div class="col-md-8">
                                                            <div class="card">
                                                                <div class="card-header">Gugatan Cerai</div>

                                                                <div class="card-body">
                                                                    <form method="POST" action="{{ route('gugatan_cerai.store') }}">
                                                                        @csrf

                                                                        <!-- Alasan Cerai -->
                                                                        <div class="form-group">
                                                                            <label for="alasan_cerai">Alasan Cerai:</label>
                                                                            <select id="alasan_cerai" name="alasan_cerai" class="form-control">
                                                                                <option value="">Pilih Alasan</option>
                                                                                <option value="(a) Perselisihan dan pertengkaran yang tidak dapat diatasi">Perselisihan dan pertengkaran yang tidak dapat diatasi</option>
                                                                                <option value="(b) Perlakuan kasar dan kekerasan fisik">Perlakuan kasar dan kekerasan fisik</option>
                                                                                <option value="(c) Perlakuan tidak wajar">Perlakuan tidak wajar</option>
                                                                                <option value="(d) Penganiayaan">Penganiayaan</option>
                                                                                <option value="(e) Selingkuh">Selingkuh</option>
                                                                                <option value="(f) Malas berkerja">Malas berkerja</option>
                                                                                <option value="(g) Tidak memberi biaya untuk keperluan rumah tangga sehingga tidak mencukupi">Tidak memberi biaya untuk keperluan rumah tangga sehingga tidak mencukupi</option>
                                                                                <option value="(h) Perkawinan Penggugat dan Tergugat dijodohkan oleh orang tua masing-masing">Perkawinan Penggugat dan Tergugat dijodohkan oleh orang tua masing-masing</option>
                                                                            </select>
                                                                        </div>
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="separation_reason" name="separation_reason" class="form-control">
                                                                        <option value="">Pilih Alasan</option>
                                                                        <option value="berpisah_tempat_tinggal">Berpisah Tempat Tinggal</option>
                                                                        <option value="berpisah_tempat_tidur">Berpisah Tempat Tidur</option>
                                                                    </select>
                                                                </div>
