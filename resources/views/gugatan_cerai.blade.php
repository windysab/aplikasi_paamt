...
<div class="container-fluid">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div
                                                            ...
                                                            RT. <input type="text" name="rt" id="rt"
                                                                class="form-control" required style="width: 30%;">
                                                            RW <input type="text" name="rw" id="rw" class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        <!-- Alasan Cerai -->
                                        <div class="form-group">
                                            <textarea name="alasan_cerai" id="alasan_cerai" class="form-control"
                                                placeholder="s" required rows="3"
                                                style="text-align: justify;"></textarea>
                                        </div>
                                        <!-- Modal -->
                                        <div class="modal fade" id="exampleModal_alasan" tabindex="-1" role="dialog"
                                            aria-labelledby="exampleModalLabel_alasan" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModal_alasan">1. Bahwa
                                                            Penggugat
                                                    ...
                                                    <form id="myForm_tergugat">
                                                        <div class="modal-body">
                                                            Hari <input type="text" name="hari" id="hari"
                                                                class="form-control" required readonly>
                                                            Tanggal <input type="date" name="tanggal" id="tanggal"
                                                                class="form-control" required>
                                                            Desa/Kelurahan <input type="text"
                                                                name="desa_kelurahan_alasan" id="desa_kelurahan_alasan"
                                                                class="form-control" required>
                                                            ...
                                                            <h6 class="modal-title" id="exampleModal_alasan">kemudian
                                                                Tergugat
                                                                mengucapkan shigat taklik talak terhadap Penggugat
                                                                sesuai dengan
                                                            ...
                                                            Tanggal Akta Nikah <input type="date"
                                                                name="tanggal_akta_nikah" id="tanggal_akta_nikah"
                                                                class="form-control" required>
                                        ...
                                        <div class="form-group">
                                            <textarea name="alasan_cerai2" id="alasan_cerai2" class="form-control"
                                                placeholder="saasd" required readonly rows="3"
                                                style="text-align: justify;"></textarea>
                                        </div>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModal_alasan2">Bahwa setelah
                                                            pernikahan tersebut Penggugat dan Tergugat bertempat tinggal
                                                        </h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                    ...
                                                    <form id="form" class="p-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="tempat_tinggal" name="tempat_tinggal"
                                                                ...
                                                                <option value="rumah_orangtua_penggugat">Di rumah
                                                                    orangtua
                                                                    Penggugat, di desa</option>
                                                                <option value="rumah_orangtua_tergugat">Di rumah
                                                                    orangtua
                                                                    Tergugat, di desa</option>
                                                                <option value="rumah_kontrakan">Di rumah kontrakan /
                                                                    kos, di
                                                                    desa</option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="d-flex">
                                                                <input type="number" id="tahun" name="tahun"
                                                                    placeholder="tahun" class="form-control mr-2">
    ...
    ${anak.map((anak, index) => `${index + 1}. Nama ${anak.nama}, tanggal lahir ${anak.tanggalLahir}`).join("\n")}`;
                                ...
                                <div class="col">
                                    <!-- Alasan Cerai3 -->
                                    <div class="form-group">
                                        <textarea name="alasan_cerai3" id="alasan_cerai3" class="form-control"
                                            placeholder="alasan_cerai3" required readonly rows="3"
                                            style="text-align: justify;"></textarea>
                                    </div>
                                    <!-- Modal -->
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header bg-primary text-white">
                                                    <h4 class="modal-title" id="myModalLabel">Alasan lainnya /
                                                        Penjelasan
                                                        kejadian</h4>
                                                </div>
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="reason" name="reason" class="form-control"
                                                            ...
                                                            <option value="(c) Memukul Penggugat">Memukul Penggugat.
                                                                ...
                                                                disediakan di bawah)</option>
                                                            <option
                                                                value="(d) Telah menjalin hubungan asmara dengan perempuan lain">
                                                            ...
                                                            <option
                                                                value="(e) Sering keluar pada malam hari / pulang pada waktu dini hari / tidak pulang berhari – hari">
                                                                Sering keluar pada malam hari / pulang pada
                                                                waktu
                                                                dini hari /
                                                                tidak pulang berhari – hari. (jelaskan kejadiannya di
                                                                tempat
                                                                yang sudah
                                                                disediakan di bawah)</option>
                                                            <option value="(f) Malas berkerja">Malas berkerja. (jelaskan
                                                                ...
                                                                disediakan di bawah)</option>
                                                            <option
                                                                value="(g) Tidak memberi biaya untuk keperluan rumah tangga sehingga tidak mencukupi">
                                                                Tidak memberi biaya untuk keperluan rumah
                                                                tangga
                                                                sehingga
                                                                tidak mencukupi. (jelaskan kejadiannya di tempat yang
                                                                sudah
                                                                disediakan di
                                                                bawah)</option>
                                                            <option
                                                                value="(h) Perkawinan Penggugat dan Tergugat dijodohkan oleh orang tua masing-masing">
                                                                Perkawinan Penggugat dan Tergugat dijodohkan
                                                                oleh
                                                                orang tua
                                                                masing-masing. (jelaskan kejadiannya di tempat yang
                                                                sudah
                                                                disediakan di
                                                                bawah)</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="reason_i_modal"
                                                            name="reason_i_modal" rows="3"></textarea>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                                    ...
                                    <div class="form-group">
                                        <textarea name="separation_details" id="separation_details" class="form-control"
                                            placeholder="Klik untuk mengisi detail" required readonly rows="3"
                                            style="text-align: justify;"></textarea>
                                    </div>


                                    <!-- Modal -->
                                    <div class="modal fade" id="myalasan" tabindex="-1" role="dialog"
                                        aria-labelledby="myModalLabel">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="separation_reason" name="separation_reason"
                                                            class="form-control">
                                                            <option value="">Pilih Alasan</option>
                                                            <option value="berpisah_tempat_tinggal">Berpisah Tempat
                                                                Tinggal
                                                            </option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="village" name="village"
                                                            class="form-control" placeholder="Masukkan nama desa">
                                                    </div>
