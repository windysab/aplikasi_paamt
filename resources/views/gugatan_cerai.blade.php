                            ...
                            <form method="POST" action="{{ route('gugatan_cerai.submit') }}">
                                ...
                                <div class="container">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat_penggugat" id="alamat_penggugat" class="form-control" required></textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat_tergugat" id="alamat_tergugat" class="form-control" required></textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tempat_menikah" id="tempat_menikah"
                                            class="form-control" required>
                                    </div>
